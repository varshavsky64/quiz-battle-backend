...
public class MatchmakingServiceImpl implements MatchmakingService {
    ...
    private final Map<String, UUID> privateRooms = new ConcurrentHashMap<>();
    ...
    protected void createMatch(UUID playerOneId, UUID playerTwoId, boolean bot) {
        ...
        MatchSession session = new MatchSession(matchEntity.getId(), playerOneId, playerTwo.getId(), bot, questions);
    ...
    private PlayerEntity createBotPlayer() {
        return playerRepository.save(new PlayerEntity("Bot"));
    }
